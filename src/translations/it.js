const it = {
  ...
  messages: {
    ...
    present: {
      ...
      p1_2: ' And it\'s true! But we all know that is not gonna happen, so, since we live in a small flat, the only thing we can think about is if you would like to contribute to our next trip. We love to travel!',
      p2_1: 'There are two countries that we\'d like to visit: ',
      p2_2: '! We are still thinking which one first.',
    ...
    venue: {
      ...
      p3: 'Following the wedding ceremony, there will be a cocktail hour and an ',
      desc: 'Vegetarian or gluten-free options will be provided if needed'
    }
  }
}
